...
hi Constant gui=NONE term=NONE cterm=NONE guifg=#ffc290 guibg=NONE ctermfg=216 ctermbg=NONE
...
hi Function gui=NONE term=NONE cterm=NONE guifg=#61efef guibg=NONE ctermfg=87 ctermbg=NONE
...
hi PreProc gui=NONE term=NONE cterm=NONE guifg=#ffc290 guibg=NONE ctermfg=216 ctermbg=NONE
...
hi Special gui=NONE term=NONE cterm=NONE guifg=#8efb8e guibg=NONE ctermfg=120 ctermbg=NONE
...
hi Statement gui=NONE term=NONE cterm=NONE guifg=#98b5f9 guibg=NONE ctermfg=111 ctermbg=NONE
hi StatusLine gui=bold term=bold cterm=bold guifg=#D7DAE1 guibg=#2C2E33 ctermfg=White ctermbg=DarkGrey
hi StatusLineNC gui=NONE term=NONE cterm=NONE guifg=#9090A0 guibg=#2C2E33 ctermfg=Grey ctermbg=DarkGrey
hi! link StatusLineTerm StatusLine
hi! link StatusLineTermNC StatusLineNC
hi! link StorageClass Type
hi String gui=NONE term=NONE cterm=NONE guifg=#c1fec1 guibg=NONE ctermfg=157 ctermbg=NONE
...
hi Type gui=NONE term=NONE cterm=NONE guifg=#8efb8e guibg=NONE ctermfg=120 ctermbg=NONE
hi! link Typedef Type
hi Underlined gui=underline term=underline cterm=underline guifg=NONE guibg=NONE ctermfg=NONE ctermbg=NONE
hi VertSplit gui=NONE term=NONE cterm=NONE guifg=#2C2E33 guibg=NONE ctermfg=DarkGrey ctermbg=NONE
...
hi WinSeparator gui=NONE term=NONE cterm=NONE guifg=#2c2e33 guibg=NONE ctermfg=236 ctermbg=NONE
hi Identifier gui=NONE term=NONE cterm=NONE guifg=#e0e2ea guibg=NONE ctermfg=254 ctermbg=NONE

" Here we enable function call highlighting for langs that don't do it by
" default.
if exists("g:neato_hl_func_calls")
    " c
    let g:c_functions = 1
